...
def main():
    ...
    def predict(output, knn_clf=None, model_path=None, distance_threshold=0.6):
        """
    ...
    if len(os.listdir("./unknown_faces")) == 0:
        ...
        my_file = Path("./trained_knn_model.clf")
        classifier = train("./known_faces", model_save_path="./trained_knn_model.clf", n_neighbors=2)
