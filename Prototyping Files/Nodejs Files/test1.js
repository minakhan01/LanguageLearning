...
// fs.watchFile('./object_recognition.txt', (curr, prev) => {
//     console.log('the current mtime is: ${curr.mtime}');
//     fs = require('fs');
//     fs.readFile('./object_recognition.txt', 'utf8', function (err,data) {
//       if (err) {
...
fs.watch('./object_recognition.txt', function (event, filename) {
