...
Instructions tested with a Raspberry Pi 2, 3, and Zero with an 8GB memory card. Based on https://github.com/ageitgey/face_recognition

## Steps

Download the [latest `Raspbian` image (with desktop)](https://www.raspberrypi.org/downloads/raspbian/). Earlier versions of Raspbian won't work.
...
```sudo nano /etc/dphys-swapfile
sudo pip3 install scikit-learn apscheduler scipy
...
If you want a desktop GUI, install PIXEL:
